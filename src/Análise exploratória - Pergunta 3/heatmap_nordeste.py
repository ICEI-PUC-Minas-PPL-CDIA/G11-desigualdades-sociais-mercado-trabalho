...
# Filtrar dados da região Nordeste
...
heatmap_ne = pd.crosstab(df_ne['Escolaridade'], df_ne['Faixa_Salarial'])
heatmap_ne = heatmap_ne.reindex(columns=faixa_ordem, fill_value=0)

# Plotar heatmap
plt.figure(figsize=(14, 6))
sns.heatmap(heatmap_ne, annot=True, fmt="d", cmap="YlGnBu", cbar_kws={'label': 'Número de Pessoas'})
plt.title('Relação entre Escolaridade e Faixa Salarial na Região Nordeste')
